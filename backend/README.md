...
## Project Structure
    ...
    ├── ideapros_llc_geneva_32415  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_geneva_32415`
...
2. Clone this repo and `cd ideapros_llc_geneva_32415`
